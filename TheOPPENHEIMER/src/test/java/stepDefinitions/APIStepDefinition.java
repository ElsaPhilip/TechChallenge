...
public class APIStepDefinition {
	...
	public void set_insertperson_request_header(String natid, String salary, String tax, String gender, String dob,
	...
	public void set_insertmultipleperson_request_header(String natid, String salary, String tax, String gender,
			String dob, String name) throws Throwable {
		this.bd = dob;
		this.gender = gender;
		this.name = name;
		this.natid = natid;
		...
		bodyPayload = "[{\"birthday\":\"" + bd + "\",\"gender\":\"" + gender + "\",\"name\":\"" + name
				+ "\",\"natid\":\"" + natid + "\",\"salary\":\"" + salary + "\",\"tax\":\"" + tax
				+ "\"},{\"birthday\":\"" + bd + "\",\"gender\":\"" + gender + "\",\"name\":\"" + name
				+ "\",\"natid\":\"" + natid + "\",\"salary\":\"" + salary + "\",\"tax\":\"" + tax + "\"}]";
